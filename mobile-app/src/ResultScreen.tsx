...
Generated by MedPlant App
  ...
  const handleDownloadPDF = async () => {
    ...
    if (!hasCredits() && !isAdmin()) {
      Alert.alert("Daily Limit Reached", "You've used today's 10 AI credits. Upgrade to continue or wait for tomorrow.");
      return;
    }
      ...
      const htmlContent = `
        ...
        <head>
          ...
          <style>
            ...
            .benefit-text { color: #444; font-size: 15px; }

            .therapeutic-box { background: #f8fcf9; padding: 20px; border-left: 4px solid #2D6A4F; border-radius: 4px; font-size: 15px; color: #2c3e50; line-height: 1.8; }
            ...
            .prep-desc { color: #555; font-size: 14px; margin: 0; }
            ...
            .explanation-box { background: #f7fafc; padding: 20px; border-radius: 8px; border-left: 4px solid #718096; color: #4a5568; font-size: 15px; }
