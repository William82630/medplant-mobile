    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <Text style={[styles.paragraph, { color: dark ? '#b0c0b8' : '#4a5a52' }]}>
            Your scan history and plant identification records are stored locally on your device. You have full control over this data and can clear your scan history at any time through the app's Settings menu. By using MedPlant, please also note the following regarding your data:
          </Text>
          <Text style={[styles.bulletItem, { color: dark ? '#b0c0b8' : '#4a5a52' }]}>
            • Account authentication data is securely processed and stored via Supabase infrastructure.
          </Text>
          <Text style={[styles.bulletItem, { color: dark ? '#b0c0b8' : '#4a5a52' }]}>
            • Payment transaction records may be retained by Razorpay in accordance with legal and regulatory requirements.
          </Text>
          <Text style={[styles.bulletItem, { color: dark ? '#b0c0b8' : '#4a5a52' }]}>
            • AI processing inputs may be transmitted to third-party services for analysis but are not retained longer than necessary for service delivery.
          </Text>
          <Text style={[styles.paragraph, { color: dark ? '#b0c0b8' : '#4a5a52' }]}>
          ...
          <Text style={[styles.paragraph, { color: dark ? '#b0c0b8' : '#4a5a52' }]}>
            MedPlant utilizes Google’s Gemini AI services to process plant images and generate identification reports. When you submit images or related inputs for plant identification, such data may be securely transmitted to Google servers for analysis in accordance with Google’s privacy and data processing policies. AI-generated results are probabilistic in nature and may contain inaccuracies.
          </Text>
          <Text style={[styles.subheading, { color: dark ? '#d0e0d8' : '#3a4a42' }]}>
            Payment Processing
          </Text>
          <Text style={[styles.paragraph, { color: dark ? '#b0c0b8' : '#4a5a52' }]}>
            MedPlant uses Razorpay as a third-party payment processor for handling transactions related to scan purchases and subscription services. Payment information, including billing details, is processed directly by Razorpay and is not stored on MedPlant servers. Razorpay processes such information in accordance with its own privacy and security policies.
          </Text>
          <Text style={[styles.subheading, { color: dark ? '#d0e0d8' : '#3a4a42' }]}>
