                ...
                <View style={[styles.dropdownMenu, { backgroundColor: dark ? '#1a2420' : '#ffffff' }]}>
                  ...
                  <TouchableOpacity style={styles.dropdownItem} onPress={() => handleMenuPress('Subscription')}>
                    ...
                    <View style={styles.dropdownTextContainer}>
                      <Text style={[styles.dropdownItemText, { color: dark ? '#f2f2f2' : '#171717', marginBottom: 4 }]}>
                        Subscription
                      </Text>
                      <Text style={[styles.dropdownBadge, { backgroundColor: dark ? '#2a3a32' : '#e8f5f0', color: dark ? '#8a9a92' : '#5b6b62', alignSelf: 'flex-start' }]}>
                        {planName}
                      </Text>
                    </View>
                  </TouchableOpacity>
